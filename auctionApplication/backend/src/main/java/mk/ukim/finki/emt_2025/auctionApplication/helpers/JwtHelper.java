package mk.ukim.finki.emt_2025.auctionApplication.helpers;
...
import mk.ukim.finki.emt_2025.auctionApplication.constants.JwtConstants;
...
public class JwtHelper {
    ...
    public String generateToken(UserDetails userDetails) {
        ...
        String token = buildToken(extraClaims, userDetails.getUsername(), JwtConstants.EXPIRATION_TIME);
